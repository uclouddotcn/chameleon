...
var makePublicKey = require('../common').makePublicPemFormat;
var makePrivateKey = require('../common').makePrivatePemFormat;
...
var HtcChannel = function(userAction, logger, cfgChecker) {
...
HtcChannel.prototype.pendingPay = function (channelName, params, infoFromSDK, callback) {
    try {
        var self = this;
...
module.exports =
{
    ...
    createSDK: function (userAction, logger, checker, debug) {
        return new HtcChannel(userAction, logger, checker, debug);
    }
};
