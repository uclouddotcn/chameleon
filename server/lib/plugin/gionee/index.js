...
var GioneeChannel = function(userAction, logger, cfgChecker) {
...
GioneeChannel.prototype.pendingPay = function (channelName, params, infoFromSDK, callback) {
    try {
        var self = this;
        ...
        var orderId = this._userAction.genOrderId().replace(/-/g, '');
...
module.exports =
{
    ...
    createSDK: function (userAction, logger, checker, debug) {
        return new GioneeChannel(userAction, logger, checker, debug);
    }
};
