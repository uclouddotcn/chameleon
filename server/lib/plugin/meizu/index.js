...
var MeizuChannel = function(userAction, logger, cfgChecker) {
...
MeizuChannel.prototype.pendingPay = function (channelName, params, infoFromSDK, callback) {
    try {
...
module.exports =
{
    ...
    createSDK: function (userAction, logger, checker, debug) {
        return new MeizuChannel(userAction, logger, checker, debug);
    }
};
