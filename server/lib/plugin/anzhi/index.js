...
var AnzhiChannel = function(userAction, logger, cfgChecker) {
...
AnzhiChannel.prototype.pendingPay = function (channelName, params, infoFromSDK, callback) {
    var self = this;
    try {
...
module.exports =
{
    ...
    createSDK: function (userAction, logger, checker, debug) {
                return new AnzhiChannel(userAction, logger, checker, debug);
            }
};
