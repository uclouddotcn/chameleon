...
var CoolpadChannel = function(userAction, logger, cfgChecker) {
...
function respondsToPay(self, req, res, next, wrapper) {
    ...
    try {
        ...
        self.userAction.pay(wrapper.channelName, obj.appuserid, null,
            orderId, status,
            null, 0, amount, other,
            function (err, result) {
                if (err) {
...
module.exports =
{
    ...
    createSDK: function (userAction, logger, cfgChecker) {
                return new CoolpadChannel(userAction, logger, cfgChecker);
            }
};
