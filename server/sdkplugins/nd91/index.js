...
var Nd91Channel = (function () {
    function Nd91Channel(logger, cfgChecker) {
    ...
    Nd91Channel.prototype.respondsToPay = function (req, res, next, wrapper) {
        ...
        try {
            ...
            wrapper.userAction.pay(wrapper.channelName, params.Uin, null, params.CooOrderSerial, status, params.GoodsId, parseInt(params.GoodsCount), Math.floor(parseFloat(params.OrderMoney) * 100), {
...
function create( logger, cfgChecker) {
    return new Nd91Channel(logger, cfgChecker);
}
