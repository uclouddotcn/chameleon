...
var HuaweiChannel = function(logger, cfgChecker) {
...
HuaweiChannel.prototype.pendingPay = function (wrapper, params, infoFromSDK, callback) {
    try {
...
module.exports =
{
    ...
    createSDK: function (logger, checker, debug) {
                return new HuaweiChannel(logger, checker, debug);
            }
};
