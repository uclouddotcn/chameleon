...
var XiaomiChannel = function(logger, cfgChecker) {
...
XiaomiChannel.prototype.respondsToPay = function (req, res, next, wrapper) {
    var self = this;
...
module.exports =
{
    ...
    createSDK: function (logger, cfgChecker) {
                return new XiaomiChannel(logger, cfgChecker);
            }
};
