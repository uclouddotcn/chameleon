...
declare module "fs-extra" {
  ...
  export function remove(dir: string, callback?: Function): void;
  export function writeJson(file: string, object, options?, callback?: Function): void;
  ...
  export function ensureDir(dir: string, callback?: Function);
  export function ensureFile(file: string, callback?: Function);
}