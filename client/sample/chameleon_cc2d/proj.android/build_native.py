...
def do_build(cocos_root, ndk_root, app_android_root,ndk_build_param,sdk_root,android_platform,build_mode):
    ...
    if ndk_build_param == None:
        command = '%s -j%d -C %s NDK_DEBUG=%d NDK_MODULE_PAH=E:\Cocos\frameworks\cocos2d-x-3.4rc1\cocos\platform\android' % (ndk_path, num_of_cpu, app_android_root, build_mode=='debug')
    else:
